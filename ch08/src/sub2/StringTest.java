...
public class StringTest {
	public static void main(String[] args) {
		...
		//문자열 인덱스
		System.out.println("sample 앞에서 부터 문자열 e 인덱스 : "+sample.indexOf("e"));
		System.out.println("sample 앞에서 부터 문자열 e 인덱스 : "+sample.lastIndexOf("e"));
		
		//문자열 교체
		System.out.println("Hello를 Welvcome으로 교체 : "+ sample.replace("Hello", "Welcome"));
